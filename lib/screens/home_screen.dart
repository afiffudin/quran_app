...
class HomeScreen extends StatelessWidget {
  ...
  TabBar _tab() {
    return const TabBar(
      ...
      indicatorColor: Color.fromARGB(255, 8, 226, 15),
      tabs: [
        Tab(
          child: Text(
            "surah",
    ...
    return Column(
      ...
      children: [
        const Text(
          "Assalamualaikum",
          style: TextStyle(
              color: AppColors.text, fontSize: 20, fontWeight: FontWeight.w500),
        ),
        ...
        Container(
          ...
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Color.fromARGB(255, 69, 241, 1),
                Color.fromARGB(255, 8, 208, 78),
                Color.fromARGB(255, 19, 190, 79)
              ],
            ),
          ),
        ),
  ...
  BottomNavigationBarItem _bottomBarItem(
      ...
      BottomNavigationBarItem(
        ...
        activeIcon: SvgPicture.asset(icon, color: AppColors.primary),
        label: label,
      );
}
